...
const CardC = ({item,add}) => {
  ...
  return (
    ...
    <Card style={{overflow:"hidden",height:"200px",padding:'10px'}} className="d-flex flex-row-reverse align-items-center">
      ...
      <button onClick={()=>add(item)} id='btn'  style={{backgroundColor:"green",width:"9rem",border:"1px solid green",borderRadius:"10px",fontWeight:"bold",color:"white",position:"absolute",top:"160px",right:"24px"}}>Add to Cart</button>
